...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(TD(DANCE_CAPS), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_EQL, KC_1, KC_2, KC_3, KC_4, KC_5, LT(1,KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, TD(DANCE_CAPS), KC_A, KC_S, KC_D, KC_F, KC_G, KC_LSPO, LT(3,KC_Z), KC_X, KC_C, KC_V, KC_B, KC_GRV, KC_INS, LT(4,KC_LEFT), LT(2,KC_RGHT), KC_TAB, KC_LALT, KC_HOME, LCTL_T(KC_BSPC), LCAG_T(KC_DEL), LT(3,KC_END), KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_SLCK, KC_PAUS, TG(1), RESET, KC_6, KC_7, KC_8, KC_9, KC_0, TD(DANCE_DASH), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC, LT(2,KC_UP), LT(4,KC_DOWN), KC_LBRC, KC_RBRC, KC_RALT, KC_RGUI, KC_PGUP, LT(3,KC_PGDN), RALT_T(KC_ENT), KC_SPC),
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [DANCE_DASH] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_1, dance_1_finished, dance_1_reset),
};
